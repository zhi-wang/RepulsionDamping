...
extern "C"
{
   ...
   /* Fortran real*8 damprep2() */
   void damp2d_(double* r, double* r2, double* rr1, double* rr3, double* rr5,
                double* rr7, double* rr9, double* rr11, int* rorder,
                double* dmpi, double* dmpk, double* dmpik);

   /* Fortran real*4 damprep2() */
   void damp2s_(float* r, float* r2, float* rr1, float* rr3, float* rr5,
                float* rr7, float* rr9, float* rr11, int* rorder, float* dmpi,
                float* dmpk, float* dmpik);
